<?php /* Smarty version Smarty-3.1.14, created on 2014-06-10 14:07:55
         compiled from "Z:\home\prestashop16.ru\www\themes\default-bootstrap\product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:107585395e167500747-85087511%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '107585395e167500747-85087511',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_5395e168249487_66003202',
  'variables' => 
  array (
    'products' => 0,
    'page_name' => 0,
...
<?php if ($_valid && !is_callable('content_5395e168249487_66003202')) {function content_5395e168249487_66003202($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'Z:\\home\\prestashop16.ru\\www\\tools\\smarty\\plugins\\function.math.php';
?>
...
">
							<span><?php echo smartyTranslate(array('s'=>'More'),$_smarty_tpl);?>
                                        ...
                                        <?php if (isset($_smarty_tpl->tpl_vars['groups']->value)){?>
                                            <?php if (count($_smarty_tpl->tpl_vars['groups']->value[1]['attributes'])){?>
 ...
 $_from = $_smarty_tpl->tpl_vars['groups']->value[1]['attributes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                                                        <div><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_attribute']->value, ENT_QUOTES, 'UTF-8', true);?>
</div>
                                                    <?php } ?>
                                                </div>
                                            <?php }?>
